...
fn ux_component_registry() -> Vec<UxComponentSpec> {
    vec![
        ...
        UxComponentSpec { id: "tabs-basic", category: "tabs", title: "Tab Navigation", primitive: "ux-tabs / ux-tab", description: "Nested tab rhythm for ordinary, disabled, hidden, starred, and admin variants.", sample: r#"<div class="ux-grid"><div class="ux-card"><h4>Basic Tabs</h4><div class="ux-tabs"><button class="ux-tab active">Home</button><button class="ux-tab">Profile</button><button class="ux-tab">Settings</button><button class="ux-tab" disabled>Disabled</button></div></div><div class="ux-card"><h4>Visibility / Starred / Admin</h4><div class="ux-tabs"><button class="ux-tab active">★ Visible</button><button class="ux-tab ux-disabled">Hidden</button><button class="ux-tab">Admin Only</button></div></div></div>"# },
        ...
        UxComponentSpec { id: "card-variants", category: "cards", title: "Cards", primitive: "ux-card", description: "Default, header, clickable, active, and error card states.", sample: r#"<div class="ux-grid"><div class="ux-card">Default card body content.</div><div class="ux-card"><h4>Card Header</h4><p>Card body content goes here.</p></div><div class="ux-card clickable">Clickable card</div><div class="ux-card active">Active card</div><div class="ux-card error">Error card</div></div>"# },
        ...
        UxComponentSpec { id: "utility-row", category: "utilities", title: "Utility Controls", primitive: "ux-row / ux-breadcrumbs", description: "Icon buttons, editable fields, and breadcrumb rows.", sample: r#"<div class="ux-grid"><button class="ux-button small" aria-label="Visibility toggle">👁</button><button class="ux-button small">＋</button><div class="ux-card">Editable field <input class="ux-field" value="editable value"></div><div class="ux-breadcrumbs"><span>/mnt</span><span>›</span><span>nas</span><span>›</span><strong>media</strong></div></div>"# },
