...
<body>
  <main class="app" data-product="Coronatio" data-source-material="homeserver-main-site" data-admin-mode="false">
    ...
    <section class="content">
      ...
      <section class="pane" id="pane-testtab" data-pane-panel="testtab" role="tabpanel" aria-label="TestTab">
        <div class="test-tablet ux-surface" data-native-stock-testtab="true" data-admin-viewport="testtab" data-react-quarry="premium/testTab" data-ux-library="coronatio-composable-ux.v1">
          <div class="ux-tabs" role="tablist" aria-label="TestTab sections" data-testtab-tabs>
            <button type="button" class="ux-tab active" data-testtab-tab="showcase" aria-selected="true">Component Showcase</button>
            <button type="button" class="ux-tab" data-testtab-tab="services" aria-selected="false">Service Tests</button>
            <button type="button" class="ux-tab" data-testtab-tab="config" aria-selected="false">Configuration</button>
            <button type="button" class="ux-tab" data-testtab-tab="health" aria-selected="false">Health Status</button>
            <button type="button" class="ux-tab" data-testtab-tab="theme-truth" aria-selected="false">Theme Truth</button>
          </div>
          <div class="test-tablet-content ux-stack">
            <section class="showcase-section active" data-testtab-panel="showcase">
              <div class="ux-tabs" role="tablist" aria-label="Component showcase categories" data-showcase-tabs>
                <button type="button" class="ux-tab active" data-showcase-tab="buttons" aria-selected="true">Buttons</button>
                <button type="button" class="ux-tab" data-showcase-tab="toggles">Toggles</button>
                <button type="button" class="ux-tab" data-showcase-tab="tabs">Tabs</button>
                <button type="button" class="ux-tab" data-showcase-tab="inputs">Inputs</button>
                <button type="button" class="ux-tab" data-showcase-tab="cards">Cards</button>
                <button type="button" class="ux-tab" data-showcase-tab="badges">Badges</button>
                <button type="button" class="ux-tab" data-showcase-tab="checkboxes">Checkboxes</button>
                <button type="button" class="ux-tab" data-showcase-tab="utilities">Utilities</button>
                <button type="button" class="ux-tab" data-showcase-tab="calendar-time">Calendar &amp; Time</button>
                <button type="button" class="ux-tab" data-showcase-tab="row-info-tile">Row Info Tile</button>
                <button type="button" class="ux-tab" data-showcase-tab="dropdowns">Dropdowns</button>
                <button type="button" class="ux-tab" data-showcase-tab="slider">Slider</button>
                <button type="button" class="ux-tab" data-showcase-tab="textbox">Text Box</button>
                <button type="button" class="ux-tab" data-showcase-tab="upload-components">Upload Components</button>
                <button type="button" class="ux-tab" data-showcase-tab="progress-bar">Progress Bar</button>
                <button type="button" class="ux-tab" data-showcase-tab="table">Table</button>
                <button type="button" class="ux-tab" data-showcase-tab="collapsible">Collapsible</button>
                <button type="button" class="ux-tab" data-showcase-tab="modals">Modals</button>
              </div>
              <div class="ux-stack" data-showcase-panels>
                <article class="ux-card showcase-section active" data-showcase-panel="buttons"><h3>Button Variants</h3><div class="ux-grid"><div class="ux-card"><h4>Primary</h4><div class="ux-row"><button class="ux-button primary">Primary Button</button><button class="ux-button primary">Home Icon</button><button class="ux-button primary" aria-busy="true">Loading</button><button class="ux-button primary ux-disabled" disabled>Disabled</button></div></div><div class="ux-card"><h4>Secondary</h4><div class="ux-row"><button class="ux-button secondary">Secondary Button</button><button class="ux-button secondary">Icon Right ›</button></div></div><div class="ux-card"><h4>Danger / Warning / Success</h4><div class="ux-row"><button class="ux-button danger">Danger Button</button><button class="ux-button warning">Warning Button</button><button class="ux-button success">Success Button</button></div></div><div class="ux-card"><h4>Sizes</h4><div class="ux-row"><button class="ux-button small">Small</button><button class="ux-button">Medium</button><button class="ux-button large">Large</button></div></div></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="toggles"><h3>Toggle Switches</h3><div class="ux-grid"><label class="ux-toggle"><input type="checkbox"> Small Toggle</label><label class="ux-toggle"><input type="checkbox" checked> Medium Toggle</label><label class="ux-toggle"><input type="checkbox" checked disabled> Disabled On</label><label class="ux-toggle"><input type="checkbox" aria-label="Toggle without label"></label></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="tabs"><h3>Tab Navigation</h3><div class="ux-grid"><div class="ux-card"><h4>Basic Tabs</h4><div class="ux-tabs"><button class="ux-tab active">Home</button><button class="ux-tab">Profile</button><button class="ux-tab">Settings</button><button class="ux-tab" disabled>Disabled</button></div></div><div class="ux-card"><h4>Visibility / Starred / Admin</h4><div class="ux-tabs"><button class="ux-tab active">★ Visible</button><button class="ux-tab ux-disabled">Hidden</button><button class="ux-tab">Admin Only</button></div></div></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="inputs"><h3>Input Fields</h3><div class="ux-grid"><label>Username<input class="ux-field" placeholder="Enter username"></label><label>Email with error<input class="ux-field" value="ab" aria-invalid="true"><span class="error">Input must be at least 3 characters</span></label><label>Password<input class="ux-field" type="password" placeholder="Enter password"></label><label>Display<input class="ux-field" value="homeserver" readonly></label></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="cards"><h3>Cards</h3><div class="ux-grid"><div class="ux-card">Default card body content.</div><div class="ux-card"><h4>Card Header</h4><p>Card body content goes here.</p></div><div class="ux-card clickable">Clickable card</div><div class="ux-card active">Active card</div><div class="ux-card error">Error card</div></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="badges"><h3>Badges</h3><div class="ux-row"><span class="ux-badge primary">Primary</span><span class="ux-badge secondary">Secondary</span><span class="ux-badge success">Success</span><span class="ux-badge warning">Warning</span><span class="ux-badge danger">Danger</span><span class="ux-badge info">Info</span></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="checkboxes"><h3>Checkboxes</h3><div class="ux-grid"><label class="ux-checkbox"><input type="checkbox" checked> Checked checkbox</label><label class="ux-checkbox"><input type="checkbox"> Unchecked checkbox</label><label class="ux-checkbox"><input type="checkbox" disabled> Disabled unchecked</label><label class="ux-checkbox"><input type="checkbox" checked disabled> Disabled checked</label></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="utilities"><h3>Utilities</h3><div class="ux-grid"><button class="ux-button small" aria-label="Visibility toggle">👁</button><button class="ux-button small">＋</button><div class="ux-card">Editable field <input class="ux-field" value="editable value"></div><div class="ux-breadcrumbs"><span>/mnt</span><span>›</span><span>nas</span><span>›</span><strong>media</strong></div></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="calendar-time"><h3>Calendar &amp; Time</h3><div class="ux-grid"><label>Weekly day<select class="ux-select"><option>Monday</option><option>Friday</option></select></label><label>Monthly day<input class="ux-field" type="number" value="15"></label><label>Time<input class="ux-field" type="time" value="03:00"></label></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="row-info-tile"><h3>Row Info Tile</h3><div class="ux-grid"><div class="ux-card"><div class="ux-row"><strong>Device</strong><span class="ux-badge success">Online</span></div><p>NAS primary · /mnt/nas · healthy</p></div><div class="ux-card"><div class="ux-row"><strong>Backup</strong><span class="ux-badge warning">Pending</span></div><p>Awaiting next sync window.</p></div></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="dropdowns"><h3>Dropdowns</h3><div class="ux-grid"><label>Device<select class="ux-select"><option>NAS Primary</option><option>Backup Drive</option></select></label><label>Strategy<select class="ux-select"><option>Safe apply</option><option>Dry run</option></select></label></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="slider"><h3>Slider</h3><div class="ux-grid"><label>CPU threshold<input type="range" min="0" max="100" value="50"></label><label>Storage warning<input type="range" min="0" max="100" value="75"></label></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="textbox"><h3>Text Box</h3><textarea class="ux-textbox" rows="8">function calculateTotal(items) { return items.reduce((sum, item) => sum + item.price, 0); }</textarea></article>
                <article class="ux-card showcase-section" data-showcase-panel="upload-components"><h3>Upload Components</h3><div class="ux-grid"><label>File<input class="ux-field" type="file"></label><div class="drop-zone"><strong>Drop zone</strong><p>Choose files for /mnt/nas</p></div><div class="ux-breadcrumbs"><span>/mnt</span><span>›</span><span>nas</span><span>›</span><strong>uploads</strong></div></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="progress-bar"><h3>Progress Bar</h3><div class="ux-stack"><div class="ux-progress"><span style="width:25%"></span></div><div class="ux-progress"><span style="width:75%"></span></div></div></article>
                <article class="ux-card showcase-section" data-showcase-panel="table"><h3>Table</h3><table class="ux-table"><thead><tr><th>Name</th><th>Status</th><th>Action</th></tr></thead><tbody><tr><td>Coronatio</td><td><span class="ux-badge success">Active</span></td><td><button class="ux-button small">Inspect</button></td></tr><tr><td>Caduceus</td><td><span class="ux-badge warning">Membrane</span></td><td><button class="ux-button small secondary">Read</button></td></tr></tbody></table></article>
                <article class="ux-card showcase-section" data-showcase-panel="collapsible"><h3>Collapsible</h3><details class="ux-card"><summary>Open details</summary><p>Composable details content.</p></details><details class="ux-card" open><summary>Open by default</summary><pre class="ux-readout">receipt: testtab.component.collapsible.v1</pre></details></article>
                <article class="ux-card showcase-section" data-showcase-panel="modals"><h3>Modals</h3><div class="ux-grid"><div class="ux-modal-sample"><h4>Small modal</h4><p>Modal body</p><div class="ux-row"><button class="ux-button secondary">Cancel</button><button class="ux-button">Confirm</button></div></div><div class="ux-modal-sample"><h4>Large modal</h4><pre class="ux-readout">[INFO] Premium tab 'testTab' reinstalled successfully</pre></div></div></article>
              </div>
            </section>
            <section class="showcase-section" data-testtab-panel="services"><div class="ux-grid"><article class="ux-card active"><h3>Data Generator</h3><p>Generate sample datasets for testing and development.</p><div class="ux-row"><span class="ux-badge success">active</span><span class="ux-badge secondary">Random Data</span><span class="ux-badge secondary">User Data</span></div><button class="ux-button small">Run action</button></article><article class="ux-card active"><h3>Analytics Processor</h3><p>Process and analyze datasets using pandas and numpy.</p><div class="ux-row"><span class="ux-badge success">active</span><span class="ux-badge secondary">Statistical Analysis</span></div><button class="ux-button small">Run action</button></article><article class="ux-card active"><h3>External API Client</h3><p>Fetch data from external APIs with timeout and error handling.</p><div class="ux-row"><span class="ux-badge success">active</span><span class="ux-badge secondary">HTTP Requests</span></div><button class="ux-button small">Run action</button></article><article class="ux-card active"><h3>Health Monitor</h3><p>Monitor premium tab dependencies.</p><div class="ux-row"><span class="ux-badge success">active</span><span class="ux-badge secondary">Status Reporting</span></div><button class="ux-button small" data-testtab-health-check>Run Health Check</button></article></div></section>
            <section class="showcase-section" data-testtab-panel="config"><article class="ux-card"><h3>Configuration</h3><div class="ux-grid"><div><h4>Basic Information</h4><p><strong>Name:</strong> testTab</p><p><strong>Description:</strong> HOMESERVER Premium Tab Framework</p><p><strong>Version:</strong> native-stock</p></div><div><h4>Capabilities</h4><div class="ux-row"><span class="ux-badge success">component_showcase</span><span class="ux-badge success">health_monitor</span><span class="ux-badge success">theme_truth</span></div></div><div><h4>Settings</h4><table class="ux-table"><tbody><tr><td>install mode</td><td>first-party-native</td></tr><tr><td>ux source</td><td>coronatio-composable-ux.v1</td></tr></tbody></table></div></div></article></section>
            <section class="showcase-section" data-testtab-panel="health"><article class="ux-card"><div class="ux-row"><h3>Health Status</h3><button class="ux-button" data-testtab-health-check>Run Health Check</button></div><pre class="ux-readout" data-testtab-health-output>{ "schema": "coronatio.testtab.health.v1", "status": "ready", "dependencies": { "rust_shell": true, "theme_catalog": true, "ux_library": true } }</pre></article></section>
            <section class="showcase-section" data-testtab-panel="theme-truth"><article class="ux-card"><h3>Theme Truth</h3><p>Dark buttons use <code>primary</code>/<code>primaryHover</code>; green is success/status only.</p><table class="ux-table theme-token-table"><thead><tr><th>token</th><th>computed</th><th>source</th></tr></thead><tbody data-theme-token-readout><tr><td>--primary</td><td>loading</td><td>dark.json primary #323840</td></tr></tbody></table></article></section>
          </div>
        </div>
      </section>
      </section>
