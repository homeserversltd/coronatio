      ...
      <section class="pane" id="pane-admin" data-pane-panel="admin" data-view-panel="admin" role="tabpanel" aria-label="Admin">
        ...
        <div class="admin-tablet" data-admin-quarry="flask-react-admin" data-admin-quarry-button-total="74" data-admin-only="true" data-admin-viewport="admin">
          ...
          <section class="admin-modal-shelf" aria-label="Admin modal controls">
            ...
            <article class="modal-window" data-admin-quarry-group="legacy-installer-modal"><div class="modal-titlebar">Legacy Installer Manager <span class="admin-quarry-note">16 buttons · legacy-installer-modal</span></div><div class="modal-body-port"><div class="modal-toolbar"><button type="button" class="modal-button admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="46" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="1" data-stub-action="true" aria-disabled="true" ><span>Back</span></button> <button type="button" class="modal-button admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="47" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="2" data-stub-action="true" aria-disabled="true" ><span>Cancel</span></button> <button type="button" class="modal-button modal-button-primary admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="48" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="3" data-stub-action="true" aria-disabled="true" ><span>Validate &amp; Clone</span></button></div><pre class="log-frame">repository clone/install log preview...</pre><div class="modal-actions"><button type="button" class="modal-button admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="49" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="4" data-stub-action="true" aria-disabled="true" ><span>Copy logs to clipboard</span></button><button type="button" class="modal-button admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="50" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="5" data-stub-action="true" aria-disabled="true" ><span>Refresh logs</span></button><button type="button" class="modal-button admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="51" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="6" data-stub-action="true" aria-disabled="true" ><span>Back</span></button><button type="button" class="modal-button admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="52" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="7" data-stub-action="true" aria-disabled="true" ><span>Cancel</span></button><button type="button" class="modal-button modal-button-primary admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="53" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="8" data-stub-action="true" aria-disabled="true" ><span>Confirm</span></button><button type="button" class="modal-button modal-button-primary admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="54" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="9" data-stub-action="true" aria-disabled="true" ><span>Add Repository</span></button><button type="button" class="modal-button modal-button-primary admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="55" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="10" data-stub-action="true" aria-disabled="true" ><span>Install All</span></button><button type="button" class="modal-button modal-button-danger admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="56" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="11" data-stub-action="true" aria-disabled="true" ><span>Uninstall All</span></button><button type="button" class="modal-button admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="57" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="12" data-stub-action="true" aria-disabled="true" ><span>View Logs</span></button><button type="button" class="modal-button admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="58" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="13" data-stub-action="true" aria-disabled="true" ><span>Refresh</span></button><button type="button" class="modal-button modal-button-danger admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="59" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="14" data-stub-action="true" aria-disabled="true" ><span>Uninstall</span></button><button type="button" class="modal-button modal-button-primary admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="60" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="15" data-stub-action="true" aria-disabled="true" ><span>Install</span></button><button type="button" class="modal-button modal-button-danger admin-quarry-button" data-admin-quarry-button data-admin-quarry-index="61" data-admin-quarry-source="components/modals/Legacy InstallerTabModal.tsx" data-admin-quarry-placement="legacy installer tab modal modes" data-admin-quarry-local-index="16" data-stub-action="true" aria-disabled="true" ><span>Delete</span></button></div></div></article>
