  ...
  <main class="app" data-product="Coronatio" data-source-material="homeserver-main-site" data-admin-mode="false">
    ...
    <section class="content" data-immortal-floor-shell data-startup-phase="Booting">
      ...
      <section class="pane" id="pane-backblaze" data-pane-panel="backblaze" data-view-panel="backblaze" role="tabpanel" aria-label="backBlaze">
        <article class="backblaze-tablet" data-backblaze-tablet><div class="backblaze-two-pane"><aside class="backblaze-bucket-pane"><header><h2>Buckets</h2><button type="button" class="ui-button ui-button--primary" data-backblaze-add>Add bucket</button></header><div data-backblaze-buckets aria-live="polite">Loading buckets…</div></aside><section class="backblaze-items-pane"><header><div><h2 data-backblaze-selected>Items</h2><p data-backblaze-bucket-status>Select a bucket.</p></div><button type="button" class="ui-button ui-button--primary" data-backblaze-run disabled>Run backup</button></header><div class="backblaze-item-controls"><label class="ui-checkbox"><input type="checkbox" data-backblaze-encrypted disabled> Encrypted</label><button type="button" class="ui-button ui-button--secondary" data-backblaze-item-add disabled>Add path</button></div><div data-backblaze-items>Select a bucket to manage paths.</div><p data-backblaze-result role="status"></p></section></div></article>
      </section>
