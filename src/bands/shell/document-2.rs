    ...
    <section class="content" data-immortal-floor-shell data-startup-phase="Booting">
      ...
      <section class="pane" id="pane-backblaze" data-pane-panel="backblaze" data-view-panel="backblaze" role="tabpanel" aria-label="Backblaze">
        <article class="backblaze-tablet" data-backblaze-tablet>
          ...
          </section><section class="backblaze-view" data-backblaze-panel="ledger" role="tabpanel" hidden><div class="backblaze-inert"><h2>Ledger</h2><p>No ledger door is seated; run history is read-only when available.</p><div data-backblaze-ledger>Loading ledger…</div></div></section>
        </article>
      </section>
