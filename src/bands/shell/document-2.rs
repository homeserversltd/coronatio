        ...
        <article class="backblaze-tablet" data-backblaze-tablet>
          ...
          <section class="backblaze-view" data-backblaze-panel="buckets" role="tabpanel">
            <div class="backblaze-two-pane"><aside class="backblaze-bucket-pane"><header><h2>Buckets</h2><button type="button" class="ui-button ui-button--primary" data-backblaze-add aria-label="Add bucket">+</button></header><div data-backblaze-buckets aria-live="polite">Loading buckets…</div></aside>
              <section class="backblaze-items-pane"><header><div><h2 data-backblaze-selected>Select a bucket</h2><p data-backblaze-bucket-status>Select a bucket.</p></div><button type="button" class="ui-button ui-button--primary" data-backblaze-run disabled>Run backup</button></header><nav class="backblaze-detail-tabs" aria-label="Selected bucket sections" role="tablist"><button type="button" class="backblaze-detail-tab is-active" data-backblaze-detail="config" role="tab" aria-selected="true">Config</button><button type="button" class="backblaze-detail-tab" data-backblaze-detail="files" role="tab" aria-selected="false">File Browser</button><button type="button" class="backblaze-detail-tab" data-backblaze-detail="forgejo" role="tab" aria-selected="false">Forgejo</button></nav>
                <div class="backblaze-config" data-backblaze-detail-panel="config"><section class="backblaze-section"><h3>Configuration</h3><label>Bucket <input class="ui-input" data-backblaze-bucket-name readonly></label><label>Prefix <input class="ui-input" data-backblaze-prefix></label><label class="ui-checkbox"><input type="checkbox" data-backblaze-encrypted disabled> Encrypted</label></section><section class="backblaze-section"><h3>Files</h3><div class="backblaze-path-input"><input class="ui-input" data-backblaze-path placeholder="/absolute/path" disabled><button type="button" class="ui-button ui-button--secondary" data-backblaze-item-add disabled>Add</button></div><div data-backblaze-items>Select a bucket to manage paths.</div></section><section class="backblaze-section"><h3>Schedule</h3><div class="backblaze-form-grid"><label>Frequency <select class="ui-input" disabled><option>Manual</option></select></label><label>Time <input class="ui-input" type="time" disabled></label></div><p class="backblaze-note">Schedule persistence is unavailable; backups run manually.</p></section><section class="backblaze-section"><h3>Managers</h3><p class="backblaze-note">No manager door is seated.</p></section><button type="button" class="ui-button ui-button--primary" data-backblaze-save disabled>Save Config</button></div>
                <div class="backblaze-inert" data-backblaze-detail-panel="files" hidden>File Browser is unavailable: no Backblaze file-browser door is seated.</div><div class="backblaze-inert" data-backblaze-detail-panel="forgejo" hidden>Forgejo integration is unavailable: no Backblaze Forgejo door is seated.</div><p data-backblaze-result role="status"></p></section>
            </div>
