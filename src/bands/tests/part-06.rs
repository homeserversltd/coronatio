    ...
    fn portals_hover_lift_reflects_motion_tranch_01() {
        ...
        for marker in [
            ...
            "REST → ENTER (pointer/focus on stage) → HOLD → EXIT → REST",
        ...
        for token in [
            "--motion-hover-raise-transform",
            "--motion-hover-raise-shadow",
            "--motion-hover-raise-duration",
    ...
    fn uxport_005_admin_markup_restores_og_structures_without_static_modal_shelf() {
        ...
        for required in [
            ...
            "class=\"ssh-status\"",
            "class=\"ssh-toggle\"",
            "ui-toggle ui-toggle--medium toggle-switch",
            "ui-toggle__slider toggle-slider",
            "class=\"toggle-label\"",
            "class=\"samba-status\"",
            "class=\"samba-toggle\"",
